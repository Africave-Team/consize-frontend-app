...
import { EnrollmentField, PublicCourse, RTDBStudent } from '@/type-definitions/secure.courses'
...
export default function SinglePublicCourses ({ params, searchParams }: { params: { id: string }, searchParams: { tryout?: boolean, cohort?: string } }) {
        ...
        <div className={`w-full min-h-screen`}>
          <div className='relative'>
            <div className='absolute top-0 left-0 w-full'>
              {/* @ts-ignore */}
              <div style={{ '--dynamic-gradient': dynamicGradient, '--dynamic-gradient-md': dynamicGradientMd }} className='md:h-80 h-96 w-full gradient-background md:gradient-background'></div>
            </div>
            <div className={`absolute top-0 left-0 w-full`}>
              <div className="flex md:flex-row flex-col">
                <div className='flex-1'>
                  ...
                  <div className='text-black py-5 md:px-16 px-5 w-full md:w-10/12'>
                ...
                <div className={`w-[450px] hidden md:block py-28`}>
