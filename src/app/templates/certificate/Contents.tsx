  ...
  const generateContent = function (data: DataInterface, certificate?: CertificatesInterface | null) {
    if (data.certificateId) {
      if (data.template) {
        ...
        } else if (["71bbefa8-1c7b-4c4e-be22-03cf44917a38", "08414197-6b2a-4697-a896-7c765e961a3d"].includes(data.certificateId)) {
          return (
        ...
        } else if (["5a4a899d-9d8f-41d4-8c4c-1556cf1e5046", "c316028a-e50a-4b21-96f3-c33595316a44"].includes(data.certificateId)) {
          return (
            <div className="template h-[700px] w-full relative">
